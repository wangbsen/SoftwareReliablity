...
# 绘制BP神经网络预测的数据
plt.plot(failure_indices_test, predictions_bp_rescaled.flatten(), label='BP神经网络预测', linestyle='--', marker='x')

# 绘制ARIMA模型预测的数据
plt.plot(failure_indices_test, predicted_failure_times_arima, label='ARIMA模型预测', linestyle='-.', marker='+')

# 标记训练集和测试集的分界线
plt.axvline(x=len(train_failure_times) + 0.5, color='red', linestyle='--', label='训练集和测试集的分界线')
...
print("BP神经网络预测误差:", errors_bp)
print("ARIMA模型预测误差:", errors_arima)